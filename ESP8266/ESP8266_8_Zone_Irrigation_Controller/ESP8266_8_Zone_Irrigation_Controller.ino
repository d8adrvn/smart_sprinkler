...
* 
 ****************************************************************************************************************************
 * ESP8266_8_Zone_Irrigation_Controller - Smart Sprinkler 8 Zones With Options for Master Valve and Pump  v1_0_1
 * 
 * Date: 2017-05-08
 * 
 ...
 * This 8 Zone device sketch has been tested and validated on the LinkNode R8 from LinkSprite.
 * 
 * Simple, elegant irrigation controller that takes advantage of the cloud and SmartThings ecosystem
 * ESP8266 with SmartThings Shield  and 8 relay modules
...
//  SPIFFS.format();
  ...
  SSDP.setHTTPPort(80);
  SSDP.setName("Smart Sprinkler Controller 8 Zones");
  SSDP.setSerialNumber("0112358132134");
  SSDP.setURL("index.html");
  SSDP.setModelName("ESP8266Irrigation_8_Zone Controller");
...
void queueManager() {
  ...
  int i=1;
  while (i<9) {
    if (trafficCop==0 && queue[i]==1) {//ready for next in line 
      trafficCop=i;
      toggleOn();
    }
    i++;
